		 ...
		 <table class="table table-borderless   table_data">
			...
			<tbody>
				...
				@foreach($transections as $transection)
					<tr class="tableRow" onclick='window.location.href =  `{{route("admin.transectionDetail", ["transection" => $transection])}}`;'>
						<td  >{{$s_no++}}</td>
						<td  >{{$transection->user->customers->name}}</td>   
						<td  >{{$transection->product->name}}</td>   
