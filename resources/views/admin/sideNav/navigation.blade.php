	...
	<div class="   " id="side_nav">
		<nav class="navbar   "  >
			...
			<ul class="navbar-nav   w-100 p-2 pb-4"   > 
				...
				<li class="nav-item  py-1 "><a  href="{{route('admin.brandList')}}"  class="nav-link px-2 py-1  rounded  admin_navigation_link" id="navigation_link_brands"    >Brands</a></li>
				...
				@auth   
				 ...
				 <li class="nav-item  py-1 d-block d-md-none"><a href="{{route('logout')}}"    class="nav-link px-2 py-1 rounded admin_navigation_link"   >Logout</a></li>		
				@endauth
	...
	<div class="offcanvas   offcanvas-start   " id="sideNavBar" style="background:rgba(var(--white-color),1);">
		...
		<div class="offcanvas-body  ">
			<nav class="navbar     w-100">
				...
				<li class="nav-item  py-1 "><a  href="{{route('admin.brandList')}}"  class="nav-link px-2 py-1  rounded  admin_navigation_link" id="navigation_link_brands1"    >Brands</a></li>
